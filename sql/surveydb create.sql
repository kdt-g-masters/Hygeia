...
-- Schema surveydb
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `surveydb` ;
USE `semidb` ;
...
-- -----------------------------------------------------
-- Table `surveydb`.`infoDisease`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `surveydb`.`infoDisease` (
...
-- Table `surveydb`.`form`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `surveydb`.`form` (
  `no` INT NOT NULL,
  ...
  `answer5` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`no`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `surveydb`.`result`
-- -----------------------------------------------------
