...
.activereviewlist{background-color: #FCA937;}
...
<body class="bg-color">
	...
	<main>
		...
		<div class="write-icon">
			<a class="btn btn-primary" href="/reviewinput">
			...
			<div class="pageInfo_area">
				<ul id="pageInfo" class="pageInfo">
					...
					<c:forEach var="num" begin="${ pageMaker.startPage }" end="${ pageMaker.endPage }">
						<li class="pageInfo_btn ${ pageMaker.cri.pageNum == num ? "activereviewlist":"" }"><a href="${ num }">${ num }</a></li>
					</c:forEach>
