...
public class ChatbotService implements NaverService{
	...
	public String test(String request, String event) { // 컨트롤러에서 event 파라미터 받아서 답변이면 send, 웰컴메시지이면 open으로 변경하여 전송
        ...
        try {
            String apiURL = "https://8gqo56nzsl.apigw.ntruss.com/custom/v1/6821/a7960ec5372a1ef0c47f06b709e720bca8cfe06f1575a86625407b5d4638c568";
            String secretKey = "VXdpS2tVaGxncGtESWlYSXFIRm9kS0dQSnlHUVVCdVE=";
